...
public class FE_MyAccountPUI {
    public static final String REGISTER_SUCCESS_MESSAGE = "xpath=//span[text()='Thank you for registering with Main Website Store.']";
    public static final String ACCOUNT_INFO_LINK = "xpath=//div[contains(@class,'sidebar')]//a[text()='Account Information']";
