...
public class FE_HomePUI {
    public static final String ACCOUNT_MENU_BUTTON = "xpath=//header[@id='header']//span[text()='Account']";;
    public static final String REGISTER_LINK = "xpath=//div[@id='header-account']//a[text()='Register']";
    public static final String LOGIN_LINK = "xpath=//div[@id='header-account']//a[text()='Log In']";
